...
void drawGame() {
	...
	case GAME_STATE_MENU:
		...
		introTxt.draw(game->getRenderer(), &cam.camRect);
...
bool loadmedia() {
	...
	introTxt = GFont(game->getRenderer(), 32, "Hello SDL Text", 200, 100, txtCol1);
